...
ess create database climate --ports=10025
...
ess select s3://asi-opendata --aws_access_key AKIAIFNLO5JVWMRZYCTQ --aws_secret_access_key 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
